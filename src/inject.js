...
function updateTab () {
  $threadTab = document.querySelector('.tabnav-pr .tabnav-tabs a')
  $threadTab.innerHTML = `
...
function loadAll () {
  $load = document.querySelector('.js-discussion .ajax-pagination-btn')
  if ($load.length) {
    $load.click()
...
function findItems () {
  ...
  $activityItems = {
    ...
    reviews: all.filter(el => contains(el, 'octicon-eye')),
  ...
  isZenhub = !!$activityItems.dependencies.length
}

function toggleActivityItems () {
  store.get(['activityVisible', 'selected'], (data) => {
    if (!data.activityVisible) {
      showItems(data.selected)
    } else {
      hideItems(data.selected)
    }
  })
}

function updateState () {
  let $selected = document.querySelectorAll('.js-sidebar-activity .select-menu-item[aria-checked=true]')
  store.set({ selected: Array.from($selected).map(el => el. el.dataset.option) })
}
...
function showItems (selected) {
  ...
  selected.map(option => $activityItems[option].map(el => el.style.display = 'flex'))
...
function hideItems (selected) {
  $activityButton.classList.remove('btn-primary')
  $activityButtonAction.innerText = 'Show'
  selected.map(option => $activityItems[option].map(el => el.style.display = 'none'))
...
function container (options) {
  ...
  container.innerHTML = `
    ...
    .js-sidebar-activity .select-menu-item:hover .Counter,
    .js-sidebar-activity .select-menu-item:focus .Counter,
    .js-sidebar-activity .select-menu-item:active .Counter {
      background: white;
    }
    </style>
    <details class="details-reset details-overlay select-menu">
      ...
      <details-menu class="select-menu-modal position-absolute right-0 hx_rsm-modal js-discussion-sidebar-menu" style="z-index: 99; overflow: visible;" data-multiple="" data-menu-max-options="10">
        <div class="select-menu-header">
          <span class="select-menu-title">Choose which items to <span class="action">toggle</span></span>
        </div>
        <div class="hx_rsm-content" role="menu">
          <div class="select-menu-list">
            <label class="select-menu-item text-normal" data-option="toggle" role="menuitemcheckbox" aria-checked="false" tabindex="0">
            ...
            <label class="select-menu-item text-normal" data-option="comments" role="menuitemcheckbox" aria-checked="true" tabindex="0">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"></path></svg>
              <input style="display:none" type="checkbox" checked value="" name="activity_select_comments">
              <div class="select-menu-item-text">
                <span class="select-menu-item-heading">
                  ...
                  ${$activityItems.comments.length ? `<span class="description js-description"><span class="Counter" style="margin-left: 4px;">${$activityItems.comments.length}</span></span>` : ''}
                  <span style="float:right">
                    <kbd>ctrl</kbd>+<kbd>a</kbd>+<kbd><strong>c</strong></kbd>
                  </span>
                </span>
              </div>
            </label>
            <label class="select-menu-item text-normal" role="menuitemcheckbox" aria-checked="true" tabindex="0">
              ...
              <div class="select-menu-item-text">
                <span class="select-menu-item-heading">
                  ...
                  ${$activityItems.users.length ? `<span class="description js-description"><span class="Counter" style="margin-left: 4px;">${$activityItems.users.length}</span></span>` : ''}
                  <span style="float:right">
                    <kbd>ctrl</kbd>+<kbd>a</kbd>+<kbd><strong>u</strong></kbd>
                  </span>
                </span>
              </div>
            </label>
            <label class="select-menu-item text-normal" data-option="labels" role="menuitemcheckbox" aria-checked="true" tabindex="0">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"></path></svg>
              ...
              <div class="select-menu-item-text">
                <span class="select-menu-item-heading">
                  ...
                  ${$activityItems.labels.length ? `<span class="description js-description"><span class="Counter" style="margin-left: 4px;">${$activityItems.labels.length}</span></span>` : ''}
                  <span style="float:right">
                    <kbd>ctrl</kbd>+<kbd>a</kbd>+<kbd><strong>l</strong></kbd>
                  </span>
                </span>
              </div>
            </label>
            <label class="select-menu-item text-normal" data-option="mentions" role="menuitemcheckbox" aria-checked="true" tabindex="0">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"></path></svg>
              ...
              <div class="select-menu-item-text">
                <span class="select-menu-item-heading">
                  ...
                  ${$activityItems.mentions.length ? `<span class="description js-description"><span class="Counter" style="margin-left: 4px;">${$activityItems.mentions.length}</span></span>` : ''}
                  <span style="float:right">
                    <kbd>ctrl</kbd>+<kbd>a</kbd>+<kbd><strong>m</strong></kbd>
                  </span>
                </span>
              </div>
            </label>
            <label class="select-menu-item text-normal" data-option="reviews" role="menuitemcheckbox" aria-checked="true" tabindex="0">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"></path></svg>
              <input style="display:none" type="checkbox" checked value="" name="activity_select_reviews">
              <div class="select-menu-item-text">
                <span class="select-menu-item-heading">
                  <svg class="octicon octicon-eye" style="height:12px;width:12px;margin:0 4px 0 0;" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M8.06 2C3 2 0 8 0 8s3 6 8.06 6C13 14 16 8 16 8s-3-6-7.94-6zM8 12c-2.2 0-4-1.78-4-4 0-2.2 1.8-4 4-4 2.22 0 4 1.8 4 4 0 2.22-1.78 4-4 4zm2-4c0 1.11-.89 2-2 2-1.11 0-2-.89-2-2 0-1.11.89-2 2-2 1.11 0 2 .89 2 2z"></path></svg>
                  <span class="">Reviews</span>
                  ${$activityItems.reviews.length ? `<span class="description js-description"><span class="Counter" style="margin-left: 4px;">${$activityItems.reviews.length}</span></span>` : ''}
                  <span style="float:right">
                    <kbd>ctrl</kbd>+<kbd>a</kbd>+<kbd><strong>r</strong></kbd>
                  </span>
                </span>
              </div>
            </label>
            <label class="select-menu-item text-normal" data-option="projects" role="menuitemcheckbox" aria-checked="true" tabindex="0">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"></path></svg>
              ...
              <div class="select-menu-item-text">
                <span class="select-menu-item-heading">
                  ...
                  ${$activityItems.projects.length ? `<span class="description js-description"><span class="Counter" style="margin-left: 4px;">${$activityItems.projects.length}</span></span>` : ''}
                  <span style="float:right">
                    <kbd>ctrl</kbd>+<kbd>a</kbd>+<kbd><strong>p</strong></kbd>
                  </span>
                </span>
              </div>
            </label>
            <label class="select-menu-item text-normal" data-option="status" role="menuitemcheckbox" aria-checked="true" tabindex="0">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"></path></svg>
              ...
              <div class="select-menu-item-text">
                <span class="select-menu-item-heading">
                  ...
                  ${$activityItems.status.length ? `<span class="description js-description"><span class="Counter" style="margin-left: 4px;">${$activityItems.status.length}</span></span>` : ''}
                  <span style="float:right">
                    <kbd>ctrl</kbd>+<kbd>a</kbd>+<kbd><strong>s</strong></kbd>
                  </span>
                </span>
              </div>
            </label>
            ${isZenhub ? `
              <label class="select-menu-item text-normal" data-option="zenhub" role="menuitemcheckbox" aria-checked="true" tabindex="0">
                <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"></path></svg>
                ...
                <div class="select-menu-item-text lh-condensed">
                  <span class="select-menu-item-heading">
                    ...
                    ${$activityItems.zenhub.length ? `<span class="description js-description"><span class="Counter" style="margin-left: 4px;">${$activityItems.zenhub.length}</span></span>` : ''}
                    <span style="float:right">
                      <kbd>ctrl</kbd>+<kbd>a</kbd>+<kbd><strong>z</strong></kbd>
                    </span>
                  </span>
                </div>
              </label>
              <label class="select-menu-item text-normal" data-option="dependancies" role="menuitemcheckbox" aria-checked="true" tabindex="0">
                <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"></path></svg>
                ...
                <div class="select-menu-item-text">
                  <span class="select-menu-item-heading">
                    ...
                    <span style="float:right">
                      <kbd>ctrl</kbd>+<kbd>a</kbd>+<kbd><strong>d</strong></kbd>
                    </span>
                  </span>
                </div>
              </label>
              <label class="select-menu-item text-normal" data-option="epics" role="menuitemcheckbox" aria-checked="true" tabindex="0">
                <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"></path></svg>
                ...
                <div class="select-menu-item-text">
                  <span class="select-menu-item-heading">
                    ...
                    <span style="float:right">
                      <kbd>ctrl</kbd>+<kbd>a</kbd>+<kbd><strong>e</strong></kbd>
                    </span>
                  </span>
                </div>
              </label>` : ''}
