...
window.addEventListener('load', function(e) {
  console.log('extension: window loaded')
  $actions = document.querySelector('.gh-header-actions')
  $activityItems = $$('.TimelineItem').filter(el => parseInt(window.getComputedStyle(el).height) < 100)
  $activityButton = $actions.appendChild(document.createElement(buttonTemplate()))
})
